...
export function Room() {
    ...
    async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
        ...
        if(likeId) {
            const roomRef = ref(database, `rooms/${roomId}/questions/${questionId}/likes/${likeId}` );
            ...
            const newPostKey = push(child(roomRef, `rooms/${roomId}/questions/${questionId}/likes`)).key;
    
            const updates = {} as any;
    
            updates[`rooms/${roomId}/questions/${questionId}/likes/` + newPostKey] = question;
